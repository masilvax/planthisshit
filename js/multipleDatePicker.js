...
(function (angular) {
    ...
    var multipleDatePicker = function () {
            return {
                ...
                '<div class="text-center picker-navigate picker-navigate-left-arrow" ng-class="{\'disabled\':disableBackButton}" ng-click="changeMonth($event, disableBackButton, -1)"><md-icon class="material-icons">keyboard_arrow_left</md-icon></div>' +
                        ...
                        var firstDayOfMonth = moment(scope.month).date(1),
                            ...
                            createDate = function () {
                                ...
                                if (angular.isArray(scope.highlightDays)) {
                                    ...
                                    day.id = hlDay.length > 0 ? hlDay[0].id : '';
                                }
