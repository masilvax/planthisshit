app.controller('mojeTreningiCtrl', function ($scope, $rootScope, $http, $window, $mdDialog) {
    ...
    $scope.pobierzListe = function () {
        ...
        let url = 'core/http_treningi.php?akcja=mojeTreningi';
    ...
    $scope.dodajNowyTrening = function (ev) {
        ...
        $scope.loaderDanych = true;
                ...
                $mdDialog.show(confirm).then(function (result) {
                    ...
                    fd.append('id', '0');
                    fd.append('id_cwiklacza', 'treningWlasnyTrenera');
